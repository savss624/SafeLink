            ...
            Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 40),
                    Container(
                        child: Text('OR', style: TextStyle(fontSize: 50))),
                    SizedBox(
                      height: 40,
                    ),
                    Row(
                  ...
                  Column(
                    ...
                    children: [
                      Text(
                        ...
                        style:
                            TextStyle(fontSize: 24, color: HexColor('ff4965')),
                      ),
                    ],
                  ),
                  Padding(
                    ...
                    child: LinearProgressIndicator(
                        ...
                        minHeight: 30.0,
                        valueColor:
                            AlwaysStoppedAnimation<Color>(HexColor('ff4965')),
                        backgroundColor: HexColor('ff4965')),
                  ),
                ]);
          });
